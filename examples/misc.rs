...
fn main() {
    ...
    while lux.is_open() {
        ...
        frame.rect(101.0, 100.0, 50.0, 50.0).set_color(color::GREEN).fill();

        frame.draw_pixel(101.5, 100.5, color::RED);
        frame.draw_pixels((0u32..100).map(|i| ((i as f32, i as f32), color::BLUE)));

        frame.rect(100.0, 100.0, 50.0, 50.0).set_color(color::GREEN).fill();
